const SecondLeftBlock = () => {
    return (<>
            <div className="inner-second-center-block">
                <h2>about our furniture</h2>
                <span>Our multifunctional collection blends design and function to suit your
...
Product specialists are available to help you create your dream space.</span>
            </div>
        </>
    )
}
